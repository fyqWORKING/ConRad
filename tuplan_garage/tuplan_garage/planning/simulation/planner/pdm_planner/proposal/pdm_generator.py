...
class PDMGenerator:
    ...
    def generate_proposals(
        ...
        self._num_agent_ahead = -100 # 最大值
        self._num_static_object_ahead = -100 # 最大值
    ...
    def _reset(
        ...
        # 维度1：proposal的batch；维度2：采样的轨迹点的数量，相当于时间维度；维度3：特征x，y，heading
    ...
    def _get_lateral_batch_dict(self) -> Dict[int, List[int]]:
        """
        key: 横向索引 value：proposal索引 一个横向索引对应多个proposal索引
